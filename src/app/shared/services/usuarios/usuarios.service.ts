...
export class UsuariosService {
  ...
  getAluno(id: string): Observable<Array<UsuariosInterface>> {
    return this.httpClient.get<Array<UsuariosInterface>>(`${this.apiUrl}?perfil=Aluno` + `/${id}`);
  }

  postAluno(aluno: UsuariosInterface) {
    return this.httpClient.post<any>(`${this.apiUrl}?perfil=Aluno`, aluno);
  }
